      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center shadow-lg rounded-md overflow-hidden bg-[#0C1F3F]">
        ...
        <h2 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-700 leading-tight mb-10 text-[#C9A84C]" >Exceptional Returns.</h2>
          <div className="flex gap-4 flex-wrap">
            <Button className=" font-serif border border-[#C9A84C] text-[#C9A84C] hover:bg-[#C9A84C] hover:text-white h-12 rounded-[0px] font-normal text-base">
              Our Strategy
            </Button>
            <Button className=" font-serif border border-[#C9A84C] text-[#C9A84C] hover:bg-[#C9A84C] hover:text-white h-12 rounded-[0px] font-normal text-base">
        ...
        <div className="border-2 border-[#C9A84C] w-[600px] h-[550px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]"></div>
          <Image
            src="/hero.png" 
